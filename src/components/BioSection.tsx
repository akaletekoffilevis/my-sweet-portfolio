          ...
          <div className="lg:col-span-4 flex flex-col items-center lg:items-start space-y-6">
            <div className="w-full max-w-xs">
              <div className="bg-app-bg border border-app-border-subtle rounded-xl overflow-hidden">
                ...
                <img
                  ...
                  alt={`Portrait de ${profile.name}, développeur backend et full-stack junior basé à Niamey`}
            ...
            <div className="flex items-center gap-2.5">
              <a href={profile.socials.github} target="_blank" rel="noreferrer" aria-label={`GitHub de ${profile.name}`}
                className="flex items-center justify-center w-12 h-12 rounded-xl border border-app-border-subtle text-app-text-muted hover:border-app-accent hover:text-app-accent hover:shadow-[0_0_16px_-4px_rgba(245,158,11,0.12)] transition-all duration-200">
              ...
              {profile.socials.whatsapp && (
                <a href={`https://wa.me/${profile.socials.whatsapp.replace(/[^0-9]/g, "")}`}
                  ...
                  className="flex items-center justify-center w-12 h-12 rounded-xl border border-app-border-subtle text-app-text-muted hover:border-green-500 hover:text-green-500 hover:shadow-[0_0_16px_-4px_rgba(34,197,94,0.12)] transition-all duration-200">
