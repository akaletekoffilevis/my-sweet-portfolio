...
export default function BioSection() {
  ...
  return (
    <section className="pt-16 sm:pt-20 md:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 border-b border-app-border-subtle relative overflow-hidden" id="bio-section">
            ...
            <div className="w-full max-w-[360px]">
              <div className="bg-app-bg border border-app-border-subtle overflow-hidden">
                <div className="flex items-center gap-1.5 px-3 py-2 bg-app-darker border-b border-app-border-subtle">
                  ...
                  <span className="text-[10px] font-mono text-app-text-muted ml-1.5">avatar.png</span>
                </div>
                <img
            ...
            <div className="flex items-center gap-2">
              ...
              {profile.socials.whatsapp && (
                <a href={`https://wa.me/${profile.socials.whatsapp.replace(/[^0-9]/g, "")}`}
                  ...
                  className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 border border-app-border-subtle text-app-text-muted hover:border-green-500 hover:text-green-500 hover:bg-green-500/5 transition-all duration-200">
          ...
          <div className="lg:col-span-8 space-y-5">
            <div className="bg-app-bg border border-app-border-subtle overflow-hidden">
              <div className="flex items-center gap-1.5 px-3 sm:px-4 py-2 bg-app-darker border-b border-app-border-subtle">
                ...
                <span className="text-[10px] sm:text-xs font-mono text-app-text-muted">about.sh</span>
              </div>
            ...
            {profile.certUrl && (
              <a href={profile.certUrl} target="_blank" rel="noopener noreferrer" aria-label="Voir le certificat freeCodeCamp"
                className="flex items-center gap-2 bg-app-bg border border-app-border-subtle p-3 sm:p-4 hover:border-app-accent/30 transition-all group">
                <span className="w-8 h-8 bg-app-accent/10 flex items-center justify-center text-app-accent font-mono font-bold text-xs shrink-0">CERT</span>
                <div className="min-w-0">
                  <p className="text-[11px] sm:text-xs font-mono font-semibold text-app-text-white truncate">Foundational C# with Microsoft</p>
                  <p className="text-[10px] sm:text-xs font-mono text-app-text-muted">freeCodeCamp — <span className="text-app-accent">Voir certificat &rarr;</span></p>
                </div>
              </a>
            )}
          </div>
