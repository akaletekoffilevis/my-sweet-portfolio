      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-4 flex flex-col items-center lg:items-start space-y-6">
            ...
            <div className="flex items-center gap-3">
              <a href={profile.socials.github} target="_blank" rel="noreferrer"
                className="p-2.5 border border-app-border-subtle rounded-lg hover:border-app-accent hover:shadow-[0_0_12px_-4px_rgba(245,158,11,0.12)] text-app-text-soft hover:text-app-accent transition-all duration-200">
              ...
              {profile.socials.whatsapp && (
                <a href={`https://wa.me/${profile.socials.whatsapp.replace(/[^0-9]/g, "")}`}
                  ...
                  className="p-2.5 border border-app-border-subtle rounded-lg hover:border-green-500 text-app-text-soft hover:text-green-500 transition-all duration-200">
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="bg-app-card card-glow rounded-2xl p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {profile.metrics.map((m, idx) => (
                <div key={idx} className="bg-app-card card-glow p-5 text-center">
